...
setwd("Q:/work/99_Working/3_Shaun/AWRA_AARS")



source("packages/awrar_AARS_v5/R/awrar.run.r")
source("packages/awrar_AARS_v5/R/get.constant.r")


if(!is.loaded("awrar_run")){
  if(Sys.info()["sysname"]=="Linux"){
    dyn.load("packages/awrar_AARS_v5/src/awrar_AARS.so")
  } else {
    dyn.load("packages/awrar_AARS_v5/src/awrar_AARS_v4.dll")
  }
}

id<-"416043"
sim_dir<-"Q:/work/99_Working/3_Shaun/AWRA_AARS/outputs/jointcalibration/v06/MDB-BorderRivers/simulations"

fn<-paste0("Q:/work/99_Working/3_Shaun/AWRA_AARS/inputs/MDB-BorderRivers/combined/combined_",id,"_sitev5.001.csv.gz")
...
fn<-paste0("Q:/work/99_Working/3_Shaun/AWRA_AARS/inputs/MDB-BorderRivers/config/config_",id,"_sitev5.001.csv")
